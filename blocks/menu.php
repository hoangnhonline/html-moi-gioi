        ...
        <div class="dm_tk">
            ...
            <span class="nut_menu111">
            	<div class="khung_menu12">
                	<ul>
                    	                    	<li><a href="#bat-dong-san/dat-nen.html">Dự án bán</a>
                        	<ul>
                            	                            </ul>
                        </li>
                                            	<li><a href="#bat-dong-san/can-ho.html">Nhà bán</a>
                        	<ul>
                            	                            </ul>
                        </li>
                                            	<li><a href="#bat-dong-san/nha-xuong.html">Nhà cho thuê</a>
                        	<ul>
                            	                            </ul>
                        </li>
                                            </ul>
...
float: left;">0822.363.589
        ...
        <span class="nut_menu111" style="float:right;">
            	<div class="khung_menu12"
                	...
                	<ul>
                    	                    	<li style="width: 120px;margin-right: 10px;"><a
